...
* `code <file>`: 在编辑器中打开或创建文件。 \[^1] ![典](../../../.gitbook/assets/典.png) ![Pasted image](<../../../.gitbook/assets/Pasted image 20251124181501.png>)
...
计算机的内存是有限的。当我们试图用有限的**位 (bits)** 来存储一个超出了它能表示范围的数值时，就会发生**溢出 (Overflow)**。这种情况，我们也可以叫做和溢位
